// src/pages/private/CrearCredito.jsx
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", background: "#FFF5AC", fontFamily: "Inter, Poppins, sans-serif" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px" }}>
        ...
        {/* Mensaje de éxito */}
        {submitSuccess && (
          <div style={{ position: "fixed", top: "80px", right: "20px", zIndex: 50, background: "#10B981", color: "white", padding: "12px 24px", borderRadius: "12px", display: "flex", alignItems: "center", gap: "10px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)" }}>
            <MaterialIcon name="check_circle" /> ¡Crédito registrado exitosamente!
          </div>
        )}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              ...
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => e.target.style.borderColor = errors.clientName && touched.clientName ? "#EF4444" : "#E5E7EB"}
                />
