...
const ListaCreditos = () => {
  ...
  const menuItems = [
    ...
    { name: "Perfil", path: "/perfil", icon: "person", active: false },
    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#F3F4F6" }}>
      ...
      >
        <div style={{ padding: "28px 20px", borderBottom: "1px solid rgba(0,0,0,0.05)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <span style={{ color: "#8C7354", fontWeight: "bold", fontSize: "1.3rem" }}>COMFÍA</span>
          </div>
        </div>
        ...
        <div style={{ padding: "20px", borderTop: "1px solid rgba(0,0,0,0.05)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
            ...
            <div>
              <p style={{ color: "#8C7354", fontSize: "0.9rem", fontWeight: 500 }}>{user?.name || "Admin User"}</p>
              <p style={{ color: "#9CA3AF", fontSize: "0.7rem" }}>Administrador</p>
            </div>
          </div>
          <button
          ...
          >
            <MaterialIcon name="logout" style={{ fontSize: "16px" }} />
            Cerrar Sesión
          </button>
        </div>
      </div>
      ...
      <div style={{ flex: 1, padding: "24px 32px", overflowY: "auto", position: "relative" }}>
        ...
        <div style={{ marginBottom: "20px" }}>
          <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#1F2937" }}>Gestión de Créditos</h1>
                ...
                {filteredCredits.map((credit) => {
                  ...
                  return (
                    <tr key={credit.id} style={{ borderBottom: "1px solid #F3F4F6" }}>
                      <td style={{ padding: "14px 16px", fontSize: "0.9rem", fontWeight: 500, color: "#1F2937" }}>{credit.client}</td>
                      ...
                      <td style={{ padding: "14px 16px", textAlign: "center" }}>
                        <div style={{ display: "flex", gap: "12px", justifyContent: "center" }}>
                          ...
                          <button onClick={() => { if (window.confirm("¿Estás seguro?")) { } }} style={{ background: "none", border: "none", cursor: "pointer", color: "#EF4444" }}>
        ...
        <div style={{ marginTop: "16px", textAlign: "center", fontSize: "0.85rem", color: "#9CA3AF" }}>
          Mostrando {filteredCredits.length} de {credits.length} registros
        </div>
      </div>
    </div>
  );
